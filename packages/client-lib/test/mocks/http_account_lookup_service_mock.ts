...
export class HttpAccountLookupServiceMock {
    ...
    public setUp(): void {
        // const tokenScope = nock(this.TOKEN_URL)
        //     .persist()
        //     .get("/")
        //     .reply(200, {
        ...
        //         "token_type": "Bearer",
        //         "scope": null,
        //         "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..zpU-HoqZK5U4ExUTpBCv_HqS0z6l0YN3oKIjvwueNwc",
        //         "expires_in": 604800,
        //         "refresh_token": null,
