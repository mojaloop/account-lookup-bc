...
describe("Client Lib - Integration tests", () => {
     beforeAll(async () => {
        ...
        await builtInOracleProvider1.associateParticipant("fsp1", "MSISDN", "123456789", "USD");
        ...
        await builtInOracleProvider2.associateParticipant("fsp2", "MSISDN", "987654321", "EUR");
